...
Public Class Pr_InformeSaldoaFavor
    ...
    Public Sub _prIniciarTodo()
        ...
        _PMIniciarTodo()
        Me.Text = "INFORME DE CUENTAS POR COBRAR"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        If CheckTodosClientes.Checked = True Then

            _dt = L_prRSaldoAFavor()
        ElseIf checkUnCliente.Checked = True Then
            Dim idCliente As Integer = 0
            idCliente = IIf(tbCodigoCliente.Text = "", -1, tbCodigoCliente.Text)
            _dt = L_prRSaldoAFavor(idCliente)
        End If
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            If CheckTodosClientes.Checked = True Then
                ...
                Dim objrep As New R_ReporteSaldoFavor
            ...
            ElseIf checkUnCliente.Checked = True Then
                ...
                Dim objrep As New R_ReporteSaldoFavorCliente
                objrep.SetDataSource(_dt)
                objrep.SetParameterValue("usuario", L_Usuario)
                'objrep.SetParameterValue("vendedor", Vendedor)
                'objrep.SetParameterValue("almacen", Almacen)
