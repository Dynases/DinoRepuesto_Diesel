...
Public Class R_movimientoBanco
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_movimientoBanco.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_movimientoBanco
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_movimientoBanco = New R_movimientoBanco()
        rpt.Site = Me.Site
        Return rpt
    End Function
