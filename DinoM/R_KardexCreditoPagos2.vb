...
Public Class R_KardexCreditoPagos2
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        If (swCreditoCliente.Value = True) Then
            _dt = L_prReporteCreditoGeneralCompras2(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), 3)
        Else
            If (CheckTodosCuenta.Checked And tbCodigoCliente.Text.Length > 0) Then
                _dt = L_prReporteCreditoProveedoresTodosCuentas2(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbCodigoCliente.Text, 3)
            End If
            If (CheckUnaCuenta.Checked And tbCodigoCliente.Text.Length > 0 And tbcodCuenta.Text.Length > 0) Then
                _dt = L_prReporteCreditoProveedorUnaCuentas2(tbcodCuenta.Text)
            End If
