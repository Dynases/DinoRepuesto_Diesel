...
Public Class R_ReporteAlertas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_ReporteAlertas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReporteAlertas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReporteAlertas = New R_ReporteAlertas()
        rpt.Site = Me.Site
        Return rpt
    End Function
