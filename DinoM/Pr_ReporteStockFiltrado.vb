...
Public Class Pr_ReporteStockFiltrado
    ...
    Private Function _prInterpretarDatos() As DataTable
        ...
        Dim dt As DataTable = L_prStockProveedorMarcaAlmacen(tbFechaI.Value.ToString("yyyy-MM-dd"), tbFechaF.Value.ToString("yyyy-MM-dd"), IIf(cbProvUno.Checked, cbProv.Value, -1), IIf(cbMarcaUno.Checked, marca, -1), IIf(cbAlmacenUno.Checked, cbPrograma.Value, -1), IIf(CheckTodosProducto.Checked = True, -1, producto))
        Return dt
        'End If
    End Function
    ...
    Private Sub cargarReporte()
        ...
        If dt.Rows.Count = 0 Then
            ...
            ToastNotification.Show(Me, "No hay datos para los parametros seleccionados.".ToUpper,
                                                  ...
                                                  eToastPosition.BottomLeft)
        Else
            Dim objrep As New R_StockFiltradas
    ...
    Private Sub tbProducto_KeyDown(sender As Object, e As KeyEventArgs) Handles tbProducto.KeyDown
        If (CheckUnoProducto.Checked) Then
            If e.KeyData = Keys.Control + Keys.Enter Then
                ...
                listEstCeldas.Add(New Modelo.Celda("yfdetprod", True, "DESCRIPCION", 500))
