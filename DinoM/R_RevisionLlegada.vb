...
Public Class R_RevisionLlegada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_RevisionLlegada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_RevisionLlegada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_RevisionLlegada = New R_RevisionLlegada()
        rpt.Site = Me.Site
        Return rpt
    End Function
