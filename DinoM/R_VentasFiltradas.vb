...
Public Class R_VentasFiltradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_VentasFiltradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasFiltradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasFiltradas = New R_VentasFiltradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
