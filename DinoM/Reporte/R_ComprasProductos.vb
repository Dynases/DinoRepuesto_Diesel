...
Public Class R_ComprasProductos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_ComprasProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ComprasProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ComprasProductos = New R_ComprasProductos()
        rpt.Site = Me.Site
        Return rpt
    End Function
