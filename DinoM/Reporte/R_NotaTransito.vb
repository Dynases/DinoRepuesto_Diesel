...
Public Class R_NotaTransito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_NotaTransito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_NotaTransito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaTransito = New R_NotaTransito()
        rpt.Site = Me.Site
        Return rpt
    End Function
