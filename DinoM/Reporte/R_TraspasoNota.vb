...
Public Class R_TraspasoNota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_TraspasoNota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_TraspasoNota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_TraspasoNota = New R_TraspasoNota()
        rpt.Site = Me.Site
        Return rpt
    End Function
