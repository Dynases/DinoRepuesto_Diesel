...
Public Class R_StockFiltradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_StockFiltradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_StockFiltradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_StockFiltradas = New R_StockFiltradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
