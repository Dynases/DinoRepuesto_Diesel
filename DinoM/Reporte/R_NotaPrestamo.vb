...
Public Class R_NotaPrestamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_NotaPrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_NotaPrestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaPrestamo = New R_NotaPrestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
