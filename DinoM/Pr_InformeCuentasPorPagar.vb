...
Public Class Pr_InformeCuentasPorPorPagar
    ...
    Public Sub _prIniciarTodo()
        ...
        _PMIniciarTodo()
        Me.Text = "INFORME DE CUENTAS POR PAGAR"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        _dt = L_fnReporteEstadoCuentasPagar(idCliente)
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New R_InformeEstadoCuentas
