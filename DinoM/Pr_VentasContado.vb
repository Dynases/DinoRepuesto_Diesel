...
Public Class Pr_VentasContado
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        If (CheckTodosAlmacen.Checked) Then
            _dt = L_prVentasContadoTodosAlmacenes(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        End If


        If (CheckUnaALmacen.Checked) Then
            If (tbAlmacen.SelectedIndex >= 0) Then
                _dt = L_prVentasContadoUnAlmacen(tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), tbAlmacen.Value)
            End If
        End If
