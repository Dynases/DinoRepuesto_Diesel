...
Public Class R_BoletaEgreso1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_BoletaEgreso1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_recibe() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_BoletaEgreso1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_BoletaEgreso1 = New R_BoletaEgreso1()
        rpt.Site = Me.Site
        Return rpt
    End Function
