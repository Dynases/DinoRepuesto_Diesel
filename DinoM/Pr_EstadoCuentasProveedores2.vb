...
Public Class Pr_EstadoCuentasProveedores2
...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prCargarReporte()
        Try
            ...
            Dt2EstadoTotal = L_prListarEstadoCuentasCompraTotal2(tbCodigoProveedor.Text, tbFechaI.Value.ToString("yyyy/MM/dd"))
            Dt1Estado = L_prListarEstadoCuentasCompra2(tbCodigoProveedor.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
