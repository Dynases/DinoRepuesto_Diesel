...
Public Class F0_SolicitudMovimiento
...
#Region "Metodos Privados"
    ...
    Sub _prGuardarTraspaso()
        Dim numi As String = ""
        Dim res As Boolean = L_prSolicitudChoferGrabar(numi, tbFecha.Value.ToString("yyyy/MM/dd"), cbConcepto.Value, tbObservacion.Text, cbAlmacenOrigen.Value, cbDepositoDestino.Value, 0, CType(grdetalle.DataSource, DataTable))
        If res Then
    ...
    Public Sub _GuardarNuevo()
        ...
        'End If
        Dim numi As String = ""
        Dim res As Boolean = L_prSolicitudChoferGrabar(numi, tbFecha.Value.ToString("yyyy/MM/dd"), cbConcepto.Value, tbObservacion.Text, gi_userSuc, cbDepositoDestino.Value, 0, CType(grdetalle.DataSource, DataTable))
        If res Then
...
salirIf:
        ...
        If (cbConcepto.SelectedIndex >= 0) Then
            If (cbConcepto.Value = 6) Then ''''Movimiento 6=Traspaso Salida
                If (CType(cbAlmacenOrigen.DataSource, DataTable).Rows.Count > 1) Then
                    ...
                    lbDepositoDestino.Text = "Deposito a Solicitar"
    ...
    Private Sub P_GenerarReporte()
        ...
        Else
            ...
            Dim dt As DataTable = l_ReporteMovimientoSolicitud(tbCodigo.Text)
