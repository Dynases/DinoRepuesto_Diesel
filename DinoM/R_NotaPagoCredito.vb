...
Public Class R_NotaPagoCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_NotaPagoCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_numi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_NotaPagoCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaPagoCredito = New R_NotaPagoCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
