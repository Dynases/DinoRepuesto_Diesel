...
#Region "Usuarios"
    ...
    Public Shared Sub L_Usuario_Grabar(ByRef _numi As String, _user As String, _pass As String, _rol As String, _estado As String, _cantDias As String, _tamFuente As String, _suc As String, _allSuc As String, _numiVend As String, _descuento As String, DescuentoProducto As String, VentaFacturado As String, VentaNormal As String, VentaMecanico As String, VentaMayorista As String, ModificarPrecio As String, VerSucursales As String)
        ...
        Dim Sql As String
        Sql = _numi + ",'" + _user + "'," + _rol + ",'" + _pass + "','" + _estado + "'," + _cantDias + "," + _tamFuente + "," + _suc + "," + _allSuc + "," + _Actualizacion + "," + _numiVend + "," + _descuento + "," + DescuentoProducto + "," + VentaNormal + "," + VentaFacturado + "," + VentaMecanico + "," + VentaMayorista + "," + ModificarPrecio + "," + VerSucursales
    ...
    Public Shared Function L_Validar_Usuario(_Nom As String, _Pass As String) As DataTable
        Dim _Tabla As DataTable
        _Tabla = D_Datos_Tabla("ydnumi,yduser,ydrol,ydpass,ydest,ydcant,ydfontsize,ydsuc,yd_numiVend,ydDescuentoGeneral,DescuentoProducto,PrecioVentaNormal,PrecioVentaFacturado,PrecioMecanico,PrecioMayorista,PuedeModificarPrecio,VerSucursales", "ZY003", "yduser = '" + _Nom + "' AND ydpass = '" + _Pass + "'")
        Return _Tabla
    End Function

    Public Shared Function L_Validar_Usuario3(_Nom As String, _Pass As String) As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@taobs", _Nom))
        _listParam.Add(New Datos.DParametro("@glosa", _Pass))
...
#Region "TY005 PRODUCTOS"
    ...
    Public Shared Function L_fnGrabarProducto(ByRef _yfnumi As String, _yfcprod As String,
                                              ...
                                              _yfsmax As Integer, _yfTipo As Integer, _yfCodAux1 As String, _yfCodAux2 As String, _yfSiatR As String, yfSiatA As String, estadoP As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@yfTipo", _yfTipo))
        _listParam.Add(New Datos.DParametro("@yfCodAux1", _yfCodAux1))
        _listParam.Add(New Datos.DParametro("@yfCodAux2", _yfCodAux2))
        _listParam.Add(New Datos.DParametro("@yfSiatA", yfSiatA))
        _listParam.Add(New Datos.DParametro("@yfSiatR", _yfSiatR))
        _listParam.Add(New Datos.DParametro("@estadoP", estadoP))
    ...
    Public Shared Function L_fnModificarProducto(ByRef _yfnumi As String, _yfcprod As String,
                                                 ...
                                                 _dtDescuento As DataTable, _dtImagenes As DataTable, _yfsmax As Integer,
                                                 _yfTipo As Integer, _yfCodAux1 As String, _yfCodAux2 As String, _yfSiatA As String, _yfSiatR As String, estadoP As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@yfCodAux1", _yfCodAux1))
        _listParam.Add(New Datos.DParametro("@yfCodAux2", _yfCodAux2))
        _listParam.Add(New Datos.DParametro("@yfSiatA", _yfSiatA))
        _listParam.Add(New Datos.DParametro("@yfSiatR", _yfSiatR))
        _listParam.Add(New Datos.DParametro("@estadoP", estadoP))
        _listParam.Add(New Datos.DParametro("@TY0051", "", TY0051))
        _listParam.Add(New Datos.DParametro("@TD001", "", _dtDescuento))
...
#Region "TY006 Categorias"
    ...
    Public Shared Function L_fnGeneralSucursalesUna(cod As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 18))
        _listParam.Add(New Datos.DParametro("@almacen", cod))
        _listParam.Add(New Datos.DParametro("@yguact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TY006", _listParam)
...
#Region "TP003 Proforma Venta Nueva"
    ...
    Public Shared Function L_fnGrabarProformaVenta(ByRef _tanumi As String, _taidCorelativo As String, _tafdoc As String, _taven As Integer,
                                                   ...
                                                   CatPrecio As Integer, _pevali As String, anticipo As Double, transferencia As Integer, banco As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@pevali", _pevali))
        _listParam.Add(New Datos.DParametro("@anticipo", anticipo))
    ...
    Public Shared Function L_fnModificarProformaVenta(_tanumi As String, _tafdoc As String, _taven As Integer, _tatven As Integer,
                                                      ...
                                                      _almacen As Integer, CatPrecio As Integer, _pevali As String) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "TV001 Ventas"
    ...
    Public Shared Function L_fnVentaNotaDeVenta(_numi As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnVentaNotaDeVentaDev(_numi As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarProductosCategoria(_almacen As String, _CatPrecio As String, idCategoria As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarProductosall(cat As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tauact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@IdCategoria", cat))
    ...
    Public Shared Function L_fnListarCategoriaVentas() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnTraerTipoPrecio(cod As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function verificarCredito(cod As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarClientes() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarSolicitud(almacen As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@ibalm", almacen))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TSM001", _listParam)
    ...
    Public Shared Function L_fnListarProductoSolicitud(_panumi As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 4))
        _listParam.Add(New Datos.DParametro("@ibid", _panumi))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TSM001", _listParam)

        Return _Tabla
    End Function

    Public Shared Function TraerStockAlmacen(prod As Integer, almacen As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 21))
        _listParam.Add(New Datos.DParametro("@producto", prod))
    ...
    Public Shared Function L_fnGrabarVenta(ByRef _tanumi As String, _taidCorelativo As String, _tafdoc As String, _taven As Integer, _tatven As Integer, _tafvcr As String, _taclpr As Integer,
                                           ...
                                           CatPrecio As Integer, Monto As DataTable, _taenvio As Double) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@tauact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@CategoriaPrecio", CatPrecio))
        _listParam.Add(New Datos.DParametro("@taEnvio", _taenvio))
        _listParam.Add(New Datos.DParametro("@TV0011", "", detalle))
    ...
    Public Shared Function L_fnModificarVenta(_tanumi As String, _tafdoc As String, _taven As Integer, _tatven As Integer, _tafvcr As String, _taclpr As Integer,
                                           _tamon As Integer, _taobs As String,
                                           _tadesc As Double, _taice As Double, _tatotal As Double, detalle As DataTable, _almacen As Integer, _taprforma As Integer, CatPrecio As Integer, _taenvio As Double) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function _prAgregarCobro(tbCodigo As String, cliente As Integer, tipo As Integer, tbObservacion As String, TotalBs As Double, TotalSus As Double, TotalTarjeta As Double,
                                           cambio As Double, banco As Integer, glosa As String, alm As Integer, tetcam As Double, salfoF As Double, bancos As DataTable) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 28))
        _listParam.Add(New Datos.DParametro("@tanumi", CInt(tbCodigo)))
        _listParam.Add(New Datos.DParametro("@taidCore", tipo))
        _listParam.Add(New Datos.DParametro("@taobs", tbObservacion))
        _listParam.Add(New Datos.DParametro("@tatotal", TotalBs))
        _listParam.Add(New Datos.DParametro("@tadesc", TotalSus))
        _listParam.Add(New Datos.DParametro("@taenvio", TotalTarjeta))
        _listParam.Add(New Datos.DParametro("@costoenv", cambio))
        _listParam.Add(New Datos.DParametro("@banco", banco))
        _listParam.Add(New Datos.DParametro("@glosa", glosa))
        _listParam.Add(New Datos.DParametro("@taalm", alm))
        _listParam.Add(New Datos.DParametro("@tetcam", tetcam))
        _listParam.Add(New Datos.DParametro("@saldoF", salfoF))
        _listParam.Add(New Datos.DParametro("@cliente", cliente))
        '_listParam.Add(New Datos.DParametro("@BA0012", "", bancos))
        _listParam.Add(New Datos.DParametro("@tauact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV001", _listParam)
        Return _Tabla
    End Function
...
#Region "TC001 Compras"
    ...
    Public Shared Function L_fnListarTiendas() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarSucursalesDes(alm As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 12))
        _listParam.Add(New Datos.DParametro("@Sucursal", alm))
    ...
    Public Shared Function L_fnListarMoneda() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarGastos() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarMarcas(cod As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_ReporteCompras(fechaI As String, fechaF As String, prov As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 19))
        _listParam.Add(New Datos.DParametro("@caty4prov", prov))
        _listParam.Add(New Datos.DParametro("@cafdoc", fechaI))
        _listParam.Add(New Datos.DParametro("@cafvcr", fechaF))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC001", _listParam)
    ...
    Public Shared Function L_fnGrabarCompra(_canumi As String, _caalm As Integer, _cafdoc As String, _caTy4prov As Integer, _catven As Integer, _cafvcr As String,
                                            ...
                                            EsPrestamo As Integer, _Proforma As String, importacion As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@EsPrestamos", EsPrestamo))
        _listParam.Add(New Datos.DParametro("@caProforma", CInt(_Proforma)))
        _listParam.Add(New Datos.DParametro("@TC0011", "", detalle))
        _listParam.Add(New Datos.DParametro("@EsImpor", importacion))
    ...
    Public Shared Function L_fnNotaTransito(_canumi As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 19))
        _listParam.Add(New Datos.DParametro("@canumi", _canumi))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TT001", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_fnNotaTransitoCostos(_canumi As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prListarEstadoCuentasCompraTotal2(idProveedor As Integer, fechai As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 11))
        _listParam.Add(New Datos.DParametro("@prov", idProveedor))
    ...
    Public Shared Function L_prListarEstadoCuentasCompra2(idProveedor As Integer, fechai As String, fechaf As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 12))
        _listParam.Add(New Datos.DParametro("@prov", idProveedor))
    ...
    Public Shared Function _lftraerPrecioCostoStock(numi As String, almacen As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function cargarDatos(dt As DataTable, almacen As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function TraerPrecioProducto(cod As String, costo As Double, taller As Double, publico As Double, gdb As Double) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 25))
        _listParam.Add(New Datos.DParametro("@yfcbarra", cod))
        _listParam.Add(New Datos.DParametro("@yfPrecioCosto", costo))
        _listParam.Add(New Datos.DParametro("@yfPrecioVentaMecanico", taller))
        _listParam.Add(New Datos.DParametro("@yfPrecioVentaNormal", publico))
        _listParam.Add(New Datos.DParametro("@yfPrecioVentaFacturado", gdb))
        _listParam.Add(New Datos.DParametro("@yfuact", L_Usuario))
    ...
    Public Shared Function ActualizarPrecioProducto(cod As Integer, costo As Double, taller As Double, publico As Double, gdb As Double) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 26))
        _listParam.Add(New Datos.DParametro("@yfnumi", cod))
        _listParam.Add(New Datos.DParametro("@yfPrecioCosto", costo))
        _listParam.Add(New Datos.DParametro("@yfPrecioVentaMecanico", taller))
        _listParam.Add(New Datos.DParametro("@yfPrecioVentaNormal", publico))
        _listParam.Add(New Datos.DParametro("@yfPrecioVentaFacturado", gdb))
...
#Region "COBROS DE LAS VENTAS CON CHEQUE"
    ...
    Public Shared Function L_fnCobranzasObtenerLosPagos(_numi As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function TraerTv0012(_numi As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "MOVIMIENTO NUEVO"
    ...
    Public Shared Function l_ReporteMovimientoSolicitud(MovimientoId As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 91))
        _listParam.Add(New Datos.DParametro("@Id", MovimientoId))
...
#Region "TI002 MOVIMIENTOS "
    Public Shared Function L_fnGeneralMovimiento(almacen As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnGeneralSolicitud() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnDetalleSolicitud(_ibid As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prMovimientoChoferGrabar(ByRef _ibid As String, _ibfdoc As String, _ibconcep As Integer, _ibobs As String, _almacen As Integer, _depositoDestino As Integer, _ibidOrigen As Integer, _detalle As DataTable, proforma As Integer, CodProf As Integer) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        ...
        _listParam.Add(New Datos.DParametro("@proforma", proforma))
        _listParam.Add(New Datos.DParametro("@codproforma", CodProf))
    ...
    Public Shared Function L_prSolicitudChoferGrabar(ByRef _ibid As String, _ibfdoc As String, _ibconcep As Integer, _ibobs As String, _almacen As Integer, _depositoDestino As Integer, _ibidOrigen As Integer, _detalle As DataTable) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 1))
    ...
    Public Shared Function L_fnListarLotesProductos(codproducto As Integer, _almacen As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerSaldoProducto(_almacen As Integer, _codProducto As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@ibuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@almacen", _almacen))
        _listParam.Add(New Datos.DParametro("@producto2", _codProducto))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TI002", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_fnObtenerHistorialProducto(_codProducto As String, FechaI As String, FechaF As String, _almacen As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnObtenerKardexGeneralProductos(FechaI As String, FechaF As String, _almacen As Integer, proveedor As Integer, Marca As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@fechaF", FechaF))
        _listParam.Add(New Datos.DParametro("@almacen", _almacen))
        _listParam.Add(New Datos.DParametro("@ibiddc", proveedor))
        _listParam.Add(New Datos.DParametro("@producto", Marca))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TI002", _listParam)
    ...
    Public Shared Function L_fnObtenerHistorialProductoGeneral(_codProducto As String, FechaI As String, _almacen As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 20))
        _listParam.Add(New Datos.DParametro("@ibuact", L_Usuario))
...
#Region "REPORTES VENTAS"
    ...
    Public Shared Function L_prVentasContadoTodosAlmacenes(fechaI As String, fechaF As String, tventa As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listParam.Add(New Datos.DParametro("@marca", tventa))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_prVentasContadoUnAlmacen(fechaI As String, fechaF As String, _numiAlmacen As String, tventa As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasDescuentosTodosAlmacenes(fechaI As String, fechaF As String, almacen As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasDescuentosUnAlmacen(fechaI As String, fechaF As String, _numiAlmacen As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasAlmacen(fechaI As String, fechaF As String, _numiAlmacen As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasAlmacenMarca(fechaI As String, fechaF As String, _numiAlmacen As Integer, Marca As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@almacen", _numiAlmacen))
        _listParam.Add(New Datos.DParametro("@marca", Marca))
        _Tabla = D_ProcedimientoConParam("Sp_Mam_ReporteVentas", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_prVentasMarca(fechaI As String, fechaF As String, Marca As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasProveedor(fechaI As String, fechaF As String, proveedor As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasProveedorAlmacen(fechaI As String, fechaF As String, proveedor As Integer, Almacen As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@proveedor", proveedor))
        _listParam.Add(New Datos.DParametro("@alamcen", Almacen))
        _Tabla = D_ProcedimientoConParam("Sp_Mam_ReporteVentas", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_prVentasProveedorMarca(fechaI As String, fechaF As String, proveedor As Integer, marca As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasProveedorMarcaAlmacen(fechaI As String, fechaF As String, proveedor As Integer, marca As Integer, almacen As Integer, producto As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@proveedor", proveedor))
        _listParam.Add(New Datos.DParametro("@numi", producto))
        _listParam.Add(New Datos.DParametro("@marca", marca))
        _listParam.Add(New Datos.DParametro("@almacen", almacen))
        _Tabla = D_ProcedimientoConParam("Sp_Mam_ReporteVentas", _listParam)
    ...
    Public Shared Function L_prStockProveedorMarcaAlmacen(fechaI As String, fechaF As String, proveedor As Integer, marca As Integer, almacen As Integer, producto As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prVentasTodos(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarMarcas() As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnListarProductosFiltro() As DataTable
        Dim _Tabla As DataTable
...
#Region "REPORTE DE CREDITOS"
    ...
    Public Shared Function L_prReporteCreditoGeneralCompras(fechaI As String, fechaF As String, Tipo As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteCreditoGeneralCompras2(fechaI As String, fechaF As String, Tipo As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prReporteCreditoProveedoresTodosCuentas2(fechaI As String, fechaF As String, _numiCliente As String, Tipo As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prReporteCreditoProveedorUnaCuentas2(_numiCredito As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnReporteMorosidadFiltros(numiVendedor As Integer, numialmacen As Integer, numicliente As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteEstadoCuentas(numicliente As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnReporteEstadoCuentasPagar(numicliente As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "CIERRE DE CAJA TCC001"
    ...
    Public Shared Function L_fnGrabarCaja(ByRef _ccnumi As String, _fecha As String, _TotalGral As Decimal, _Credito As Decimal,
        ...
        Return _resultado
    End Function
    Public Shared Function L_fnModificarCaja(ByRef _ccnumi As String, _fecha As String, _TotalGral As Decimal, TotalBs As Decimal,
                                          TotalDls As Decimal, IngresoBs As Decimal, IngresoDls As Decimal, EgresoBs As Decimal,
                                          EgresoDls As Decimal, direfencia As Decimal, _Turno As String, _MInicial As Decimal,
                                          inicialbs As Decimal, inicialdls As Decimal, _TipoCambio As Decimal, _Obs As String,
                                          _TCC0012 As DataTable, _TCC0013 As DataTable, _NroCaja As Integer, _TCC0011 As DataTable) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@fecha", _fecha))
        _listParam.Add(New Datos.DParametro("@TotalGral", _TotalGral))
        _listParam.Add(New Datos.DParametro("@Credito", TotalBs))
        _listParam.Add(New Datos.DParametro("@Tarjeta", TotalDls))
        _listParam.Add(New Datos.DParametro("@ContadoBs", IngresoBs))
        _listParam.Add(New Datos.DParametro("@Depositos", IngresoDls))
        _listParam.Add(New Datos.DParametro("@Efectivo", EgresoBs))
        _listParam.Add(New Datos.DParametro("@Diferencia", EgresoDls))
        _listParam.Add(New Datos.DParametro("@Pagos", direfencia))
        _listParam.Add(New Datos.DParametro("@Turno", _Turno))
        _listParam.Add(New Datos.DParametro("@MInicial", _MInicial))
        _listParam.Add(New Datos.DParametro("@Estado", 0))
        _listParam.Add(New Datos.DParametro("@Ingreso", inicialbs))
        _listParam.Add(New Datos.DParametro("@Egreso", inicialdls))
        _listParam.Add(New Datos.DParametro("@TipoCambio", _TipoCambio))
        _listParam.Add(New Datos.DParametro("@Obs", _Obs))
        _listParam.Add(New Datos.DParametro("@ccuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@Nrocaja", _NroCaja))
        _listParam.Add(New Datos.DParametro("@TCC0011", "", _TCC0012))
        _listParam.Add(New Datos.DParametro("@TCC0012", "", _TCC0013))
        _listParam.Add(New Datos.DParametro("@TCC0013", "", _TCC0011))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TCC001", _listParam)
    ...
    Public Shared Function L_prCajaGeneral(sucursal As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function _TraerUltimoCierre() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 12))
        _listParam.Add(New Datos.DParametro("@ccuact", L_Usuario))
    ...
    Public Shared Function L_fnDetalleVentasPagos2(fecha As String, Sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "INGRESOS/EGRESOS"
    ...
    Public Shared Function L_prIngresoEgresoGeneral(Sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prIngresoEgresoGrabar(ByRef _ienumi As String, _ieFecha As String, _ieTipo As String,
                                           ...
                                           _ieObs As String, _ieRec As String, _NroCaja As Integer, _Sucursal As Integer, _idDevolucion As String) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@ieRec", _ieRec))
    ...
    Public Shared Function L_prTraspasoGrabar(_ieFecha As String, _Sucursal As Integer, _SucursalDestino As Integer, _ieMonto As Decimal,
                                           _ieObs As String, usuario As Integer, tipo As Integer, usersuc As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _listParam.Add(New Datos.DParametro("@ieFecha", _ieFecha))
        _listParam.Add(New Datos.DParametro("@sucursalDestino", _SucursalDestino))
        _listParam.Add(New Datos.DParametro("@ieMonto", _ieMonto))
        _listParam.Add(New Datos.DParametro("@ieObs", _ieObs))
        _listParam.Add(New Datos.DParametro("@Sucursal", _Sucursal))
        _listParam.Add(New Datos.DParametro("@IdDevolucion", tipo))
        _listParam.Add(New Datos.DParametro("@ievend", usuario))
        _listParam.Add(New Datos.DParametro("@ieEstado", usersuc))
        _listParam.Add(New Datos.DParametro("@ieuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TIE001", _listParam)
    ...
    Public Shared Function L_prTraspasoNota(usersuc As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prIngresoEgresoModificar(ByRef _ienumi As String, _ieFecha As String, _ieTipo As String,
                                           _ieDescripcion As String, _ieConcepto As String, _ieMonto As Decimal,
                                           _ieObs As String, _ieRec As String, _Sucursal As Integer, _idDevolucion As String) As Boolean
    ...
    Public Shared Function L_prIngresoEgresoEntreFecha(fechaI As String, fechaF As String, NroCaja As Integer, Sucursal As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@ieFecha", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _listParam.Add(New Datos.DParametro("@Nrocaja", NroCaja))
        _listParam.Add(New Datos.DParametro("@Sucursal", Sucursal))
        _listParam.Add(New Datos.DParametro("@ieuact", L_Usuario))
    ...
    Public Shared Function L_prIngresoEgresoSaldo(fechaI As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prIngresoEgresoSaldo2(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prIngresoEgresoSaldo21(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prIngresoEgresoSaldoAnterior(fechaI As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prSaldoAnterior(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "TD002 DEVOLUCIONES"
    ...
    Public Shared Function L_fnGeneraCostoImportacion() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "BANCOS"
    ...
    Public Shared Function L_prDtealleTransferencia() As DataTable
        Dim _Tabla As DataTable
...
#Region "MOVIMIENTO BANCOS"
    ...
    Public Shared Function L_prMovimientoGrabar(ByRef _manumi As String, _maFecha As String, _maTipo As String,
                                                      ...
                                                      _maMonto As Decimal, _maObs As String, maConcep As Integer, iddev As Integer) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@concep", maConcep))
        _listParam.Add(New Datos.DParametro("@maEstado", 1))
        _listParam.Add(New Datos.DParametro("@idDev", iddev))
        _listParam.Add(New Datos.DParametro("@mauact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TMB001", _listParam)
    ...
    Public Shared Function L_prMovimientoBancoModificar(ByRef _manumi As String, _maFecha As String, _maTipo As String,
                                                      _maSucursal As Integer, _mabanco As Integer, _maNboleta As String, _maDetalle As String,
                                                      _maMonto As Decimal, _maObs As String, maConcep As Integer) As Boolean
    ...
    Public Shared Function TraerConceptosTraspaso() As DataTable
        Dim _Tabla As DataTable
...
#End Region
    ...
    Public Shared Function revisarMontos(banco As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@maBanco", banco))
        _listParam.Add(New Datos.DParametro("@mauact", L_Usuario))
        '_listParam.Add(New Datos.DParametro("@maBanco", _maBanco))
        _Tabla = D_ProcedimientoConParam("Sp_Mam_TMB001", _listParam)
    ...
    Public Shared Function _GuadarCostos(CodTransito As Integer, CodProv As Integer, total As Double, dt As DataTable) As DataTable

        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 18))
        _listParam.Add(New Datos.DParametro("@canumi", CodTransito))
        _listParam.Add(New Datos.DParametro("@caty4prov", CodProv))
        _listParam.Add(New Datos.DParametro("@catotal", total))
        _listParam.Add(New Datos.DParametro("@cauact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@gastos", "", dt))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TT001", _listParam)
        Return _Tabla
    End Function

    Public Shared Function _ModificarCostos(CodTransito As Integer, CodProv As Integer, total As Double, dt As DataTable) As DataTable
...
#Region "Transferencia de dinero"

    Public Shared Function L_prTransferenciaDinero(alm As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prTraerSaldoAFavor(Cliente As Integer) As Double
        Dim _Tabla As DataTable
        Dim monto As Double
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 32))
        _listParam.Add(New Datos.DParametro("@almacen", Cliente))
        _listParam.Add(New Datos.DParametro("@tauact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV001", _listParam)
        If _Tabla.Rows.Count > 0 Then
            monto = _Tabla.Rows(0).Item("monto")
        Else
            monto = 0
        End If
        Return monto
    ...
    Public Shared Function L_prRSaldoAFavor() As DataTable
        Dim _Tabla As DataTable
        Dim monto As Double
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prRSaldoAFavor(Cliente As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim monto As Double
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "Transito"
    Public Shared Function L_fnGrabarTransito(_canumi As String, _caalm As Integer, _cafdoc As String, _caTy4prov As Integer, _catven As Integer, _cafvcr As String,
                                            _camon As Integer, _caobs As String, _cadesc As Double, _catotal As Double, detalle As DataTable, detalleCompra As DataTable,
                                            _emision As Integer, _numemision As Integer, _consigna As Integer, _retenc As Integer, _tipocambio As Double,
                                            EsPrestamo As Integer, _Proforma As String, bandImport As Integer) As Integer
        Dim _Tabla As DataTable
        'Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        '   @canumi ,@caalm,@cafdoc ,@caty4prov  ,@catven,
        ...
        _listParam.Add(New Datos.DParametro("@TC0011", "", detalle))
        _listParam.Add(New Datos.DParametro("@EsImpor", bandImport))
        '_listParam.Add(New Datos.DParametro("@TFC001", "", detalleCompra))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TT001", _listParam)
    ...
    Public Shared Function L_fnModificarTransito(_canumi As String, _caalm As Integer, _cafdoc As String, _caTy4prov As Integer, _catven As Integer, _cafvcr As String,
                                            _camon As Integer, _caobs As String, _cadesc As Double, _catotal As Double, detalle As DataTable, detalleCompra As DataTable,
                                            _emision As Integer, _numemision As Integer, _consigna As Integer, _retenc As Integer, _tipocambio As Double,
                                            EsPrestamo As Integer, _Proforma As String, bandImport As Integer) As Integer
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnGeneralTransito(EsPrestamo As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnGeneralGastos(cod As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 16))
        _listParam.Add(New Datos.DParametro("@canumi", cod))
        _listParam.Add(New Datos.DParametro("@cauact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC001", _listParam)
    ...
    Public Shared Function RegistrarAnticipo(fecha As String, concep As Integer, obs As String, almacen As Integer, doc As Integer, monto As Double) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 9))
        _listParam.Add(New Datos.DParametro("@fdev", fecha))
        _listParam.Add(New Datos.DParametro("@tven", concep))
        _listParam.Add(New Datos.DParametro("@obs", obs))
        _listParam.Add(New Datos.DParametro("@almacen", almacen))
        _listParam.Add(New Datos.DParametro("@tanumi", doc))
        _listParam.Add(New Datos.DParametro("@total", monto))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TD002", _listParam)

        Return _Tabla
    End Function
    Public Shared Function L_fnDetalleTransito2(_numi As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnDetalleProformaCompra2(_numi As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fGeneralTransitoNoUtilizado() As DataTable
        Dim _Tabla As DataTable
